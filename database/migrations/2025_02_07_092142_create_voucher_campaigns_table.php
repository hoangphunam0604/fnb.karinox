...
return new class extends Migration
{
  ...
  public function up(): void
  {
    Schema::create('voucher_campaigns', function (Blueprint $table) {
      ...
      $table->unsignedInteger('target_quantity')->comment('Số voucher dự kiến tạo');
      $table->unsignedInteger('generated_quantity')->default(0)->comment('Số voucher đã tạo');
      $table->unsignedInteger('used_quantity')->default(0)->comment('Số voucher đã sử dụng');
      ...
      $table->string('code_format', 50)->default('{PREFIX}{RANDOM_8}')->comment('Format pattern for codes');
      $table->unsignedInteger('code_length')->default(8)->comment('Length of random part');
