...
class VoucherCampaignRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    ...
    return [
      ...
      'voucher_template.discount_type' => 'required|string|in:fixed,percent',
      'voucher_template.discount_value' => 'required|numeric|min:0',
      'voucher_template.max_discount' => 'nullable|numeric|min:0|required_if:voucher_template.discount_type,percent',
  ...
  public function messages(): array
  {
    return [
      ...
      'voucher_template.max_discount.required_if' => 'Maximum discount is required for percent discount type.',
