...
use App\Http\Admin\Controllers\AuthController;
...
Route::prefix('admin')->group(function () {
  Route::get('/products/kiot-viet', [ProductController::class, 'kiotViet']);

  Route::post('auth/login', [AuthController::class, 'login']);
  // Admin routes: require API auth, app check, branch context and only allow users with role admin or manager
  Route::middleware(['auth:api', 'is_karinox_app', 'set_karinox_branch_id', 'role:admin|manager'])->group(function () {
